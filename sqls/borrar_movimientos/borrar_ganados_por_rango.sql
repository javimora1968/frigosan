  DELETE FROM dba.fr_ganados
	WHERE  ( dba.fr_ganados.fec_bscla_indvdual >= convert(datetime,'12/25/2010 00:00:00') ) AND  
     	 	 ( dba.fr_ganados.fec_bscla_indvdual <= convert(datetime,'12/31/2010 23:59:59') )   ;
...
//         ( dba.fr_ganados.fec_bscla_indvdual >= convert(datetime,'08/30/2010 00:00:00') ) AND  
//         ( dba.fr_ganados.fec_bscla_indvdual <= convert(datetime,'08/31/2010 23:59:59') )   ;



////   WHERE dba.fr_ganados.id_entrada < 26800   ;


////   WHERE dba.fr_ganados.id_entrada <= 27000   
////ORDER BY dba.fr_ganados.id_entrada ASC  ;
//