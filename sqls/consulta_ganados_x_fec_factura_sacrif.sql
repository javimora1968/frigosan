  SELECT dba.fr_ganados.id_empresa,   
    ...
    FROM dba.fr_ganados  
   WHERE (dba.fr_ganados.fecha_factura_sacrificio >= convert(datetime,'02/10/2002 00:00:00') OR  
         dba.fr_ganados.fecha_factura_sacrificio <= convert(datetime,'02/11/2002 23:59:59')) AND  
         dba.fr_ganados.estado_animal = 'R'   ;
