alter table dba.fr_encab_plan_sacrif  add
       val_uni_abono numeric(16,2) null,
       tot_abono numeric(16,2) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_encab_plan_sacrif');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_encab_plan_sacrif',
        object_id('dba.fr_encab_plan_sacrif'),
        'dba',  'val_uni_abono', 25,
        'Val Uni Abono:', 0 ,
        'Val Uni Abono', 0,
       24 , '[General]',
       0 , 65 , 385 ,
