alter table dba.fr_items_plan_sacrif  add
       ind_abono char(1) null,
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_items_plan_sacrif');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_items_plan_sacrif',
        object_id('dba.fr_items_plan_sacrif'),
        'dba',  'ind_abono', 23,
        'Ind Abono:', 0 ,
        'Ind Abono', 0,
       23 , '',
