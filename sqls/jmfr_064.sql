create table dba.fr_rastro_cambio_dato_animales
...
alter table dba.fr_rastro_cambio_dato_animales
       add constraint pk_fr_rastro_cambio_datos primary key  nonclustered
       (id_empresa,
       id_entrada,
       id_res,
       ind_esp_mayor,
