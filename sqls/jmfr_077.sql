alter table dba.fr_enc_entrada  add
       n_entrada_subasta numeric(10,0) null,
       consec_lote_subasta numeric(6,0) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_enc_entrada');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_enc_entrada',
        object_id('dba.fr_enc_entrada'),
        'dba',  'n_entrada_subasta', 51,
        'N Entrada Subasta:', 0 ,
        'N Entrada Subasta', 0,
       24 , '[General]',
       0 , 65 , 270 ,
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_enc_entrada',
        object_id('dba.fr_enc_entrada'),
        'dba',  'consec_lote_subasta', 52,
        'Consec Lote Subasta:', 0 ,
        'Consec Lote Subasta', 0,
       24 , '[General]',
       0 , 65 , 197 ,
        '', 'N',
