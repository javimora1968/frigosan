create table dba.fr_conf_cont_abonos
       ...
       cta_credito char(20) not null,
       id_usuario char(4) not null,
       fec_registro datetime not null);

alter table dba.fr_conf_cont_abonos
       add constraint pk_fr_conf_cont_abonos primary key  nonclustered
       (id_empresa,
       ind_lin_mayor,
       id_especie,
       id_evento);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'fr_conf_cont_abonos',
       object_id('dba.fr_conf_cont_abonos'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
