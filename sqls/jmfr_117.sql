alter table dba.oe_extracto_factura_cliente  add
       valor_doc_cobrar double precision null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.oe_extracto_factura_cliente');
