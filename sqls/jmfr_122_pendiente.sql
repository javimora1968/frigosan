create table dba.encab_cheq_devueltos
       ...
       ind_contabilizado char(1) not null,
       tipo_comprobante char(4) not null,
       num_comprobante numeric(12,0) not null,
       usr_anula char(8) not null,
       fec_anula datetime not null,
       num_cheque varchar(20) not null,
       id_banco char(15) not null);

alter table dba.encab_cheq_devueltos
       add constraint pk_oe_encab_cheq_devueltos primary key  nonclustered
       (id_empresa,
       id_documento,
       num_documento);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'encab_cheq_devueltos',
       object_id('dba.encab_cheq_devueltos'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
