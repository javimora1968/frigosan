create table dba.fr_medios_pago_anticipos
...
alter table dba.fr_medios_pago_anticipos
       add constraint pk_fr_medios_pago_anticipos primary key  nonclustered
       (id_empresa,
       id_forma_pago,
       id_medio_pago);
...
insert into dbo.pbcattbl
       ...
       pbt_cmnt)
       values  ( 'fr_medios_pago_anticipos',
       object_id('dba.fr_medios_pago_anticipos'),
        'dba',
        -10,  400,  'N',  'N',  0,  34,
        'Arial',
        -10,  400,  'N',  'N',  0,  34,
