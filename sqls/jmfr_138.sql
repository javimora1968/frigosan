alter table dba.fr_conf_cont_abonos  add
       cta_debito_anticipos char(20) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_conf_cont_abonos');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'cta_debito_anticipos', 12,
        'Cta Debito Anticipos:', 0 ,
        'Cta Debito Anticipos', 0,
       23 , '',
       0 , 65 , 421 ,
        '', 'N',
