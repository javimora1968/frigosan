alter table dba.fr_items_recaudo  add
       tipo_doc_anticipo char(8) null,
       num_doc_anticipo numeric(18,0) null,
       item_anticipo numeric(6,0) null,
       id_bod_zona_anticipo char(10) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_items_recaudo');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_items_recaudo',
        object_id('dba.fr_items_recaudo'),
        'dba',  'id_bod_zona_anticipo', 19,
        'Id Bod Zona Anticipo:', 0 ,
        'Id Bod Zona Anticipo', 0,
       23 , '',
       0 , 65 , 238 ,
        '', 'N',
