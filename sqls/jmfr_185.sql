alter table dba.fr_ganados  add
       id_usuario_manual char(15) null,
       fec_registro_cambio_manual datetime null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_ganados',
        object_id('dba.fr_ganados'),
        'dba',  'fec_registro_cambio_manual', 75,
        'Fec Registro Cambio Manual:', 0 ,
        'Fec Registro Cambio Manual', 0,
       23 , '',
       0 , 65 , 385 ,
        '', 'N',
