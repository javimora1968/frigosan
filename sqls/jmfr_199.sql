alter table dba.fr_recaudo  add
       ultimo_cambio_factura datetime null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_recaudo');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_recaudo',
        object_id('dba.fr_recaudo'),
        'dba',  'ultimo_cambio_factura', 49,
        'Ultimo Cambio Factura:', 0 ,
        'Ultimo Cambio Factura', 0,
       23 , '',
       0 , 65 , 385 ,
        '', 'N',
