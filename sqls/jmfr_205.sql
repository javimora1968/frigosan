alter table dba.fr_formularios_sacrificio  add
       fecha_factura_sac datetime null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_formularios_sacrificio');
