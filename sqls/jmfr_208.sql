alter table dba.fr_encab_factura  add
       num_formulario_sacrificio numeric(18,0) null,
       animales_segun_formulario numeric(4,0) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'num_formulario_sacrificio', 66,
        'Num Formulario Sacrificio:', 0 ,
        'Num Formulario Sacrificio', 0,
       24 , '[General]',
       0 , 65 , 421 ,
        '', 'N',
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_encab_factura',
        object_id('dba.fr_encab_factura'),
        'dba',  'animales_segun_formulario', 67,
        'Animales Segun Formulario:', 0 ,
        'Animales Segun Formulario', 0,
       24 , '[General]',
       0 , 65 , 165 ,
        '', 'N',
