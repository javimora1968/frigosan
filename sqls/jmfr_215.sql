alter table dba.fr_conceptos_facturacion  add
       tope_peso numeric(18,2) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_conceptos_facturacion');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_conceptos_facturacion',
        object_id('dba.fr_conceptos_facturacion'),
        'dba',  'tope_peso', 26,
        'Tope Peso:', 0 ,
        'Tope Peso', 0,
       24 , '[General]',
