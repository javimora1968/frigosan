alter table dba.fr_log_cambios_datos_animales  add
       propio_original char(1) null,
       propio_final char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_log_cambios_datos_animales');
