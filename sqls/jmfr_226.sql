alter table dba.fr_ganados  add
       nombre_plaza_carne1 varchar(60) null,
       nombre_plaza_carne2 varchar(60) null;
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        ...
        'dba',  'nombre_plaza_carne1', 86,
        'Nombre Plaza Carne1:', 0 ,
        'Nombre Plaza Carne1', 0,
       23 , '',
       0 , 65 , 1153 ,
        '', 'N',
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_ganados',
        object_id('dba.fr_ganados'),
        'dba',  'nombre_plaza_carne2', 87,
        'Nombre Plaza Carne2:', 0 ,
        'Nombre Plaza Carne2', 0,
       23 , '',
       0 , 65 , 1153 ,
        '', 'N',
