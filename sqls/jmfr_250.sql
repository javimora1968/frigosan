alter table dba.fr_sac_propios  add
       ind_deshuese_cabeza char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_sac_propios');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_sac_propios',
        object_id('dba.fr_sac_propios'),
        'dba',  'ind_deshuese_cabeza', 14,
        'Ind Deshuese Cabeza:', 0 ,
        'Ind Deshuese Cabeza', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
