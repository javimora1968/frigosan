alter table dba.oe004_cliente_sucursal  add
       nit_surtidor char(15) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.oe004_cliente_sucursal');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'oe004_cliente_sucursal',
        object_id('dba.oe004_cliente_sucursal'),
        'dba',  'nit_surtidor', 134,
        'Nit Surtidor:', 0 ,
        'Nit Surtidor', 0,
       23 , '',
       0 , 65 , 325 ,
