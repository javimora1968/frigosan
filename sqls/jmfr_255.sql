alter table dba.fr_canales  add
       ind_almacena_media1 char(1) null,
       ind_almacena_media2 char(1) null;
...
update dbo.pbcattbl set
       ...
       pbt_cmnt = ' '
        where pbt_tid = object_id('dba.fr_canales');
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_canales',
        object_id('dba.fr_canales'),
        'dba',  'ind_almacena_media1', 36,
        'Ind Almacena Media1:', 0 ,
        'Ind Almacena Media1', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
...
insert into dbo.pbcatcol
       ...
       pbc_init, pbc_cmnt, pbc_edit, pbc_tag)
        values  ( 'fr_canales',
        object_id('dba.fr_canales'),
        'dba',  'ind_almacena_media2', 37,
        'Ind Almacena Media2:', 0 ,
        'Ind Almacena Media2', 0,
       23 , '',
       0 , 65 , 69 ,
        '', 'N',
