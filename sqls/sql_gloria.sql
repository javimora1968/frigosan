  SELECT dba.fr_canales.id_empresa,   
    ...
    FROM dba.fr_canales  
   WHERE ( dba.fr_canales.fec_ingreso between convert(datetime,'06/15/2005 00:00:00') and convert(datetime,'06/15/2005 23:59:59') ) AND  
         ( dba.fr_canales.ind_lin_mayor = 'N' )   ;
